...
export default function UserHud(props) {
    ...
    const computedCompanion = 
      ...
      props.state.gameStates.companion === 'cat' ? 'cat.png' : 
      props.state.gameStates.companion === 'turtle' ? 'turle.png' : 
        ...
        <React.Fragment>
            <div className="user-wrapper">
              ...
              <div className='companion-img-wrap'>
                <img className="user-img" alt="user-character" src={`./companions/${computedCompanion}`}/>
              </div>
            </div>
